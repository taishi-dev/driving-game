...
test("perfect run: score 100, mm:ss clear time, 'great drive' summary (ja) — pins the full 6-field record", () => {
...
test("clear time pads minutes and seconds to two digits and floors seconds (NO centiseconds)", () => {
  const at = (ms: number) =>
...
// History screen rank badge (original ui/HistoryScreen.tsx getScoreRank, ported P10).
