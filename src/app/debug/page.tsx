...
// Import each of the created objects
// Note: adjust the paths to match the actual file structure
  ...
  return (
    <div style={{ width: "100%", height: "100vh", backgroundColor: "#1e1e1e" }}>
      ...
      <div style={{ position: "absolute", top: 20, right: 20, zIndex: 10, color: "white", textAlign: "right" }}>
        ...
        <p style={{ margin: 0, opacity: 0.7 }}>Mouse controls: Rotate (left drag) / Pan (right drag) / Zoom (wheel)</p>
      </div>
      ...
      <Canvas camera={{ position: [0, 5, 10], fov: 50 }}>
        ...
        {/* === Lay out the models side by side === */}
...
// Helper component that displays text above a model
