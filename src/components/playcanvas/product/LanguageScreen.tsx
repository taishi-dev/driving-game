...
/**
 * P7a — first-launch language picker (shown only when no `language` is saved;
 * see the `screen` initializer in store.ts). Presented in English like the
 * original; choosing persists via the store's setLanguage and proceeds to Home.
 */
