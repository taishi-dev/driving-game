...
/**
 * B10 — real auth screen for the Babylon product (replaces the StubScreens
 * placeholder). Ported from the original `src/components/auth/AuthScreen.tsx`:
...
export function AuthScreen() {
  ...
  // client); offer guest play instead.
